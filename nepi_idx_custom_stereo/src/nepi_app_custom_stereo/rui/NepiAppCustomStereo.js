...
// Custom Stereo Depth application page (OUTLINE / SKELETON).
//
...
//   * A process-select dropdown + Reload button (NepiAppCustomStereo-Controls,
...
//     family.)
class NepiAppCustomStereo extends Component {

  constructor(props) {
    super(props)

    this.state = {
      appName: "app_custom_stereo",
      appNamespace: null,
  ...
  updateStatusListener(namespace) {
    ...
    if (namespace != null && namespace.indexOf('null') === -1) {
      ...
      var statusListener = this.props.ros.setupStatusListener(
        statusNamespace,
        "nepi_app_custom_stereo/NepiAppCustomStereoStatus",
        this.statusListener
      )
  ...
  render() {
    ...
    return (
      <Section title={(this.props.title !== undefined) ? this.props.title : "Custom Stereo Depth"}>
        {body}
      </Section>
    )
  }
...
export default NepiAppCustomStereo
